...
class AgencyLeaderBoardScrean extends StatefulWidget {
  const AgencyLeaderBoardScrean({super.key});
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    return Container(decoration: const BoxDecoration(image: DecorationImage(image: ExactAssetImage('assets/image/Agencyrank.png'),fit: BoxFit.cover)),
      child: Scaffold(backgroundColor: Colors.transparent,  appBar: AppBar(centerTitle: false,automaticallyImplyLeading: true,leading:  IconButton(
        ...
        child: IconButton(
          ...
          onPressed: () => navigateTo(context: context, screen: const SearchAgencyScrean()),
        ),
            ...
            child: Column(
              children: [
                ...
                Expanded(child: Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 15),
                  child: Container(decoration: const BoxDecoration(color: Colors.white,borderRadius: BorderRadius.only(topLeft: Radius.circular(20),topRight:  Radius.circular(20),)),
