...
class _FollowingMomentsState extends State<FollowingMoments> {
  ...
  Widget build(BuildContext context) {
    ...
    return  ListView.separated( physics:const BouncingScrollPhysics(),controller:_controller2,itemCount: posts.FollowPosts.length,separatorBuilder: (context, index) => Padding(
