...
setState(() {
                    ...
                    InkWell(
                      onTap: () {
                        ...
                        if (user.LoginPassword.text.isEmpty||user.LoginID.text.isEmpty) {
                        } else {
                          if(user.value==false){
                      ...
                      child: Center(
                        child: Container(
                          decoration: BoxDecoration(
                              color: user.LoginID.text.isNotEmpty&& user.LoginPassword.text.isNotEmpty?const Color(0xFF1878f3).withValues(alpha: 0.8):Colors.black12,
